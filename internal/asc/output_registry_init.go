...
func registerAllOutputRenderers() {
	...
	registerRows(developerBundleIDCapabilityDisableResultRows)
	...
	registerRowsWithSingleResourceAdapter(subscriptionOfferCodesRows)
	...
	registerRows(appClipAdvancedExperienceRemoveResultRows)
