...
**Transaction Tax reports are not available through the public API.** An
authenticated web-session command is available for the captured
App Store Connect finance flow:
...
The manual App Store Connect flow remains available:
